      ...
      <>
        <section>
          <div className="px-4 py-8 mx-auto max-w-screen-2xl sm:px-6 sm:py-12 lg:px-8">
            ...
            <div>
              <div className="px-4 py-8 mx-auto max-w-screen-2xl sm:py-12 sm:px-6 lg:px-8">
                <div className="grid grid-cols-1 gap-4 lg:grid-cols-3 lg:items-stretch">
                  <div className="grid p-6 bg-gray-100 rounded place-content-center sm:p-8">
                    <div className="max-w-md mx-auto text-center lg:text-left">
                      ...
                      <Link
                        href="/products"
                        className="inline-block px-12 py-3 mt-8 font-medium transition duration-75 border rounded text-md text-text border-accent hover:text-primary hover:border-primary focus:outline-none focus:ring"
                      >
                        Shop All
                      </Link>
                    </div>
