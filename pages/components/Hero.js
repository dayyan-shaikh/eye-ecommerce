...
export default function Hero({ product }) {
  ...
  return (
    <>
      <div className="container flex flex-wrap items-center justify-center min-h-screen p-8 mx-auto xl:px-0">
        <div className="flex items-center w-full lg:w-1/2">
          <div className="max-w-2xl mb-8">
            ...
            Welcome to <b className="text-black">ClearView Optics</b>, where style meets clarity! Discover a stunning collection of eyewear that blends fashion-forward designs with cutting-edge vision technology. 
            </p>
            ...
            <div className="flex flex-col items-start space-y-3 sm:space-x-4 sm:space-y-0 sm:items-center sm:flex-row">
              ...
              >
                <button
                  type="submit"
                  className="relative z-10 flex items-center justify-center gap-2 px-4 py-2 mx-auto overflow-hidden text-lg border-2 rounded-full shadow-xl bg-gray-50 backdrop-blur-md lg:font-semibold isolation-auto border-gray-50 before:absolute before:w-full before:transition-all before:duration-700 before:hover:w-full before:-left-full before:hover:left-0 before:rounded-full before:bg-indigo-600 hover:text-gray-50 before:-z-10 before:aspect-square before:hover:scale-150 before:hover:duration-700 group"
                >
                  All Products
                  <svg
